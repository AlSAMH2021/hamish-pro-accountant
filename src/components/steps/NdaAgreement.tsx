        ...
        <div className="bg-card rounded-2xl shadow-card p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">يرجى قراءة الاتفاقية والموافقة عليها قبل البدء بالاختبار</p>
            </div>
          </div>
          ...
          <div className="bg-muted/30 rounded-xl p-5 space-y-4 text-sm text-foreground leading-relaxed max-h-[400px] overflow-y-auto">
            ...
            <p>بموجب هذه الاتفاقية، أتعهد أنا المتقدم/ة للاختبار بالآتي:</p>

            <ol className="list-decimal space-y-3 pr-5">
              <li>
                <strong>السرية التامة:</strong> أتعهد بالحفاظ على سرية جميع أسئلة الاختبار ومحتوياته وعدم مشاركتها مع أي طرف آخر بأي شكل من الأشكال (شفهياً، كتابياً، إلكترونياً، أو بأي وسيلة أخرى).
              </li>
              <li>
                <strong>عدم التصوير أو النسخ:</strong> أتعهد بعدم تصوير أو نسخ أو تسجيل أي جزء من الاختبار أو نتائجه التفصيلية.
              </li>
              <li>
                <strong>الاستخدام الشخصي:</strong> أقر بأن هذا الاختبار مخصص لاستخدامي الشخصي فقط ولا يجوز لي السماح لأي شخص آخر بالوصول إليه.
              </li>
              <li>
                <strong>حماية الملكية الفكرية:</strong> أقر بأن جميع محتويات الاختبار هي ملكية فكرية خاصة بمؤسسة هامش للتدريب ومحمية بموجب قوانين حقوق الملكية الفكرية.
              </li>
              <li>
